...
>>>>>>> 4000a61aa566fe8c88f2528a671d5f902b5c4778
...
```
```{r}
# This looks correct. Note: TRUE is the default 
# so was not needed above
my_data
```

## Using qplot to make a histogram, scatter plot, or dot plot
```{r}
# This command makes a histogram of the `lifeExp` 
# column of the `my_data` dataset
...
# The linear regression model (`lm`) will be added on 
# top of our previous plot
qplot(x = gdpPercap,
      y = lifeExp,
      log = 'x',

...
[Part 2](https://beep-boopr.github.io/MultiPanelPlotsWithR/articles/group-02_Piping-single-panel-ggplot-figs.html) and ultimately to Part 3 (which we recommend going through only *after* completing 
Part 2) [here](https://beep-boopr.github.io/MultiPanelPlotsWithR/articles/group-03_Using-cowplot-multi-panel.html).
...
[this zip file](https://github.com/beep-boopR/MultiPanelPlotsWithR/raw/master/inst/extdata/UBC-BIOL548L_data_files.zip).
...
**Note:** Unless specified, default arguments are automatically assigned. Here, `n = 10` overrides the default (hidden) argument of `n = 6` and produces the first 10 observations of `my_data`.
...
qplot(x = gdpPercap, y = lifeExp, data = my_data)?qplot
```
```{r}
...
### Congratulations! You finished part 1!! Now check out [part 2](https://beep-boopr.github.io/MultiPanelPlotsWithR/articles/group-02_Piping-single-panel-ggplot-figs.html)
